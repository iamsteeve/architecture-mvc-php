...
class CategoryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Models.Map.CategoryTableMap';
     ...
     */
    const OM_CLASS = '\\App\\Models\\Category';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Models.Category';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Models\\Category');
    ...
    {
        $this->addRelation('Task', '\\App\\Models\\Task', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':category_id',
    1 => ':id',
  ),
), null, 'CASCADE', 'Tasks', false);
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Models\Category) { // it's a model object
